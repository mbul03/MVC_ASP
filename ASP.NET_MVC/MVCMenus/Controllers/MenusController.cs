...
namespace MVCMenus.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public ActionResult Details(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                menumodel = r.Menus1.FirstOrDefault(x => x.MenuCode == code);
            }
        ...
        public ActionResult Edit_Get(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                menumodel = r.Menus1.Where(x => x.MenuCode == code).FirstOrDefault();
            }
        ...
        public ActionResult Edit_Post(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                var m = r.Menus1.Where(x => x.MenuCode == code).FirstOrDefault();
                TryUpdateModel(m);
                r.SaveChanges();
            }
        ...
        public ActionResult Delete_Post(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                var m = r.Menus1.Remove(r.Menus1.FirstOrDefault(x => x.MenuCode == code));
                TryUpdateModel(m);
                r.SaveChanges();
            }
